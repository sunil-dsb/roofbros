...
const META = {
  ...
  'ic-download':    { name: 'Download',          source: 'hand-drawn', licence: 'no external licence' },
  'ic-circle':      { name: 'Circle (markup)',   source: 'hand-drawn', licence: 'no external licence' },
  'ic-undo':        { name: 'Undo (markup)',     source: 'hand-drawn', licence: 'no external licence' },
...
const USED_FOR = {
  ...
  'ic-download':    'E3 "Download data sheet"',
  'ic-circle':      'Photo markup toolbar (D1b viewer) — circle a detail',
  'ic-undo':        'Photo markup toolbar (D1b viewer) — undo the last mark',
